...
class America_Mexico extends StatefulWidget {
   America_Mexico({super.key});
  @override
  State<America_Mexico> createState() => _America_MexicoState();
}

class _America_MexicoState extends State<America_Mexico> {
